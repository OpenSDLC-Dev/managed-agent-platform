...
**Size: 60–120 words, hard cap 1,500 bytes.** A fragment holds what a reader of
the release notes needs — what changed, what it means for them, and the issue
or PR number. It is not where a change is explained in full. Every longer form
already has a mandated home, and writing it here too means maintaining it in
two places:
