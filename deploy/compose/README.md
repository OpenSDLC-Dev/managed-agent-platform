...
| `EXECUTOR_REAP_INTERVAL` | Sandbox reap pass interval, a Go duration (default `1m`). Each pass destroys the sandboxes of deleted, archived, and terminated sessions; live sessions are never touched. |
