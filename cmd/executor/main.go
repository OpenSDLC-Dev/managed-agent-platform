...
//	                         retried on the next pass rather than failing the run
...
// operator could write one where the matcher canonicalizes and be refused where
// it is read (plan 43, #609).
