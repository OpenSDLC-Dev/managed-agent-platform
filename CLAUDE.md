...
make sdk-bump-report     # (outside the gate) what an SDK pin bump moved under: anchors gone at the pin, `absent at` anchors back at it, line spans the sources contradict, stamps behind it, and what went unchecked (plan 51)
