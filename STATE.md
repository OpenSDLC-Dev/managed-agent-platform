...
- CI (`.github/workflows/ci.yml`: build / vet / gofmt / `test -count=1`) + branch→review→PR→CI→squash-merge iteration workflow with dual code review (`/codex:review` + `/code-review`) (CLAUDE.md → "Iteration workflow").
