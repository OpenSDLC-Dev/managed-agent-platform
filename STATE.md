...
**none** — #269 (the chart's Cloud SQL Auth Proxy sidecar and the brain's Google identity)
finished 2026-08-04. Configuration only: the proxy path is unrun on a live GKE cluster.
