...
- **Current focus:** an operator surface to issue environment keys
  ([#43](https://github.com/OpenSDLC-Dev/managed-agent-platform/issues/43)) — the one gap
  before a self-hosted deploy is turn-key.
...
- **Backlog & open questions:** [GitHub issues](https://github.com/OpenSDLC-Dev/managed-agent-platform/issues)
  ...
  Wire assumptions awaiting a real managed-agents recording are #58–#61, #63, #78.
...
- **Module path** `github.com/OpenSDLC-Dev/managed-agent-platform` — the owner's mixed
  case is intentional and must match the GitHub owner exactly.
