...
- [x] Slice 5 — `DIVERGENCES.md` 313 KB → 228 KB: the 24 entries grown into design essays
      ...
      the same PR, plans being cited by slice number and by role. Four targets retired, why in the plan.
