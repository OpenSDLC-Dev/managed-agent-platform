...
2026-07, moved unchanged — except relative links re-based for this
directory, byte-reversibly — by plan 28 slice 2. A newer month stays in
HISTORY.md until it archives.
