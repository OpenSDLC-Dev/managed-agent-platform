...
this guide it comes from one of those runs. Not every number here is one — published prices
and configured values appear too, and are not run evidence. The sizing figures below are
