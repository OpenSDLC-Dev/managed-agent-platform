...
- **Continuous delivery to the GCP staging environment** (#347; the ref assertion below was
  ...
  [docs/deploy-gcp.md](../deploy-gcp.md) under "Exposing the control plane". `model-providers`
