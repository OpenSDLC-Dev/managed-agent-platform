...
// Stop stops a work item and returns the updated item. The returned item is for
// callers inside the process — the wire Stop answers a bodiless 204, unlike
// ack/heartbeat — so the API handler discards it. force
