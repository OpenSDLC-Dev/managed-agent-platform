...
func TestFileSentinelsAreToolErrors(t *testing.T) {
	cases := []struct {
		...
		// reference has rendered an unmapped errno since anthropic-sdk-go
		// v1.63.0 — agenttoolset.go fsErrorMessage), and a bare sentinel falls
		// back to its own words (plan 23, #306).
