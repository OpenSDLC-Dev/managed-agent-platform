...
func TestSessionCreateValidation(t *testing.T) {
	...
	for name, tc := range map[string]struct {
		...
		"resources unsupported": {map[string]any{"agent": agentID, "environment_id": envID,
			"resources": []any{map[string]any{"type": "file", "file_id": "file_x"}}}, 400, "invalid_request_error"},
